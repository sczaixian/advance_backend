...
func TestBlock() {
	...
	// Alchemy提供了稳定的以太坊API端点，替换URL中的API密钥即可使用
	client, err := ethclient.Dial("https://eth-sepolia.g.alchemy.com/v2/RmsPYhly5O6-XH8UdmqCQ")
	if err != nil {
		// 如果连接失败，记录错误并终止程序
	...
	blockNumber := big.NewInt(9028872)
	...
	// 打印区块头信息：
	fmt.Println("区块高度:", header.Number.Uint64())    // 区块的编号 9028872
